...
export default function SearchBar() {
  ...
  return (
    <section className="relative py-12 md:py-16 bg-gradient-to-b from-black/90 to-black/70 overflow-hidden border-t border-amber-900/20">
      ...
      <div className="container mx-auto relative z-10 max-w-6xl px-4">
        ...
        >
          ...
          >
            <div className="relative flex items-center golden-glow">
              <input
                ref={inputRef}
                type="text"
                value={inputValue}
                ...
                className="w-full bg-black/80 backdrop-blur-md text-white text-sm sm:text-base md:text-lg lg:text-xl font-light tracking-wide border border-amber-700/50 rounded-full py-3 sm:py-4 md:py-5 lg:py-6 px-4 sm:px-6 md:px-8 pr-10 sm:pr-12 md:pr-14 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition-all duration-300"
              />
              <motion.div 
